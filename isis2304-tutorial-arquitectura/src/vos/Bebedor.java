...
public class Bebedor {
	...
	//Requerimiento 1A: Cree un atributo tipo Long para representar el id. Este debe tener el mismo nombre que la etiqueta
	private long id;
	...
	//Requerimiento 1B: Cree un atributo tipo String para representar el nombre. Este debe tener el mismo nombre que la etiqueta
	private String nombre;

	/**
	 * Presupuesto del bebedor. Puede ser Alto, Medio o Bajo.
	 */
	//Requerimiento 1C: Agregue la anotacion @JsonProperty para el atributo que representa el presupuesto. Esta debe tener el mismo nombre que el atributo
	 ...
	 * Ciudad del bebedor
	 */
	//Requerimiento 1D: Agregue la anotacion @JsonProperty para el atributo que representa la ciudad. Esta debe tener el mismo nombre que el atributo
